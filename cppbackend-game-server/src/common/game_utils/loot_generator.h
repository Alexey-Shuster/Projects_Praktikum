...
public:
    ...
    /*
     * Возвращает количество трофеев, которые должны появиться на карте спустя заданный промежуток времени.
     ...
     */
    size_t Generate(TimeInterval time_delta, size_t loot_count, size_t looter_count);
