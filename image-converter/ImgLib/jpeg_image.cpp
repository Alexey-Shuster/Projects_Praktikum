...
bool SaveJPEG(const Path& file, const Image& image) {
    ...
    // Шаг 2: устанавливаем destination файл
#ifdef _MSC_VER
    ...
    // Шаг 3: устанавливаем параметры сжатия
    ...
    // Вызов jpeg_set_quality убран по требованию

    // Шаг 4: начинаем сжатие
    jpeg_start_compress(&cinfo, TRUE);

    // Шаг 5: обрабатываем scanlines
    ...
    while (cinfo.next_scanline < cinfo.image_height) {
        ...
        // Конвертируем строку изображения в формат JPEG (RGB)
